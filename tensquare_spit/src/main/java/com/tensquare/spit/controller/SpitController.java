...
public class SpitController {
    ...
    public Result fidnById(@PathVariable String spitId) {
    ...
    public Result findBypatentId(@PathVariable String parentid, @PathVariable int page, @PathVariable int size) {
